...
class MainMenuState extends MusicBeatState
{
	...
	override function create()
	{
		...
		{
			var offset:Float = 118 - (Math.max(optionShit.length, 4) - 4) * 80;
		...
		add(versionShit);
		var versionShit:FlxText = new FlxText(12, FlxG.height - 24, 0, "FNF SONIC PAJERO V" + Application.current.meta.get('version'), 12);
		versionShit.scrollFactor.set();
		versionShit.setFormat("VCR OSD Mono", 16, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		add(versionShit);
